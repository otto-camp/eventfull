...
<div class="flex gap-2 md:gap-4 border rounded-box border-base-content/30">
	...
	<div class="btn-group btn-group-vertical">
		<button on:click={() => (showModal = true)} class="btn btn-error btn-outline p-2 flex-1">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="24"
				height="24"
		...
		<button class="btn btn-info btn-outline p-2 flex-1">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="24"
				height="24"
